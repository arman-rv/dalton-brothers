...
import footerLight from '../../../../src/assets/Images/landing-footer.svg'
import footerDark from '../../../../src/assets/Images/landing-footer-mode.svg'
...
const LandingFooter = () => {
  ...
  return (
    ...
    style={
      colorMode === "dark"
        ? {
            backgroundImage: `url(${footerDark})`,
          }
        : {
            backgroundImage: `url(${footerLight})`,
          }
    }
      className={` max-xl:!bg-[url('')] xl:bg-no-repeat max-xl:flex-col-reverse  xl:h-[600px] xl:bg-[length:100vw] xl:bg-bottom xl:bg-transparent xl:items-end  md:items-center flex flex-row-reverse justify-between flex-nowrap items-start w-[100%] h-fit dark:bg-DarkPallete-100 bg-[#fcbf49] max-md:items-center  `}
    >
      ...
      <div className="w-[550px] h-[650px] max-xl:w-full max-xl:h-[700px]  flex justify-center items-center xl:ml-16 cursor-pointer " onClick={openModal}>
        <img
