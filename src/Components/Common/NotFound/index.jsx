  ...
  return (
    ...
    >
      <div className="w-[100-vw] h-[100vh] bg-white flex items-end  flex-col font-irSans ">
        ...
        <div className="w-1/2 h-60  z-20 mt-40 flex flex-col justify-center  items-center gap-10 text-2xl text-mode-700 "> 
        صفحه مورد نظر یافت نشد 
        
        <NavLinks className={"bg-pallete-100 text-white text-base"} Children={" بازگشت به صفحه اصلی"} path={"/"} />
